...
class _PolylineAnimationExampleState extends State<PolylineAnimationExample> {
 ...
 //late LatLng _driverLocation = LatLng(10.333815213195546, 123.92990351576007); // Example driver location
 ...
 Set<Marker> _markers = {};
  ...
  Future<void> _fetchRoute() async {
    final apiKey = 'xxxxxxxxxx'; // Replace with your API key
  ...
  Future<void> _animateRoute(List<LatLng> polylinePoints) async {
    ...
    const int updateInterval = 50; // Interval between position updates in milliseconds
    ...
    //   final double t = i / numUpdates ;
    //   final double lat = _userLocation.latitude + t * (_driverLocation.latitude - _userLocation.latitude);
    //   final double lng = _userLocation.longitude + t * (_driverLocation.longitude - _userLocation.longitude);
